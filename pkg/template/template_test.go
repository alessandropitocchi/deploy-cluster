...
func TestDefaultTemplate(t *testing.T) {
	...
	if cfg.Plugins.ArgoCD == nil {
		t.Fatal("ArgoCD template should not be nil")
	}
...
func TestSaveAndLoad_WithPlugins(t *testing.T) {
	...
	original := &Template{
		...
		Cluster:  ClusterTemplate{ControlPlanes: 1, Workers: 1},
...
func TestLoad_FileNotFound(t *testing.T) {
	_, err := Load("/nonexistent/path/template.yaml")
	if err == nil {
...
func TestValidate_ValidTemplate(t *testing.T) {
	...
	if err := cfg.Validate(); err != nil {
		t.Errorf("Validate() should pass for default template, got: %v", err)
	}
}
...
func TestValidate_InvalidProviderType(t *testing.T) {
	cfg := &Template{
		Name:     "test",
		Provider: ProviderTemplate{Type: "docker-desktop"},
		Cluster:  ClusterTemplate{ControlPlanes: 1, Workers: 0},
	}
	err := cfg.Validate()
	if err == nil {
...
func TestValidate_ZeroControlPlanes(t *testing.T) {
	cfg := &Template{
		Name:     "test",
		Provider: ProviderTemplate{Type: "kind"},
		Cluster:  ClusterTemplate{ControlPlanes: 0, Workers: 1},
	}
	err := cfg.Validate()
	if err == nil {
...
func TestValidate_MultipleErrors(t *testing.T) {
	cfg := &Template{} // everything missing
	err := cfg.Validate()
	if err == nil {
...
func TestValidate_DisabledArgoCDSkipsValidation(t *testing.T) {
	cfg := &Template{
		...
		Plugins: PluginsTemplate{
			ArgoCD: &ArgoCDTemplate{
				Enabled: false,
				Apps:    []ArgoCDAppTemplate{{Name: ""}}, // invalid but disabled
			},
		},
	}
	if err := cfg.Validate(); err != nil {
...
func TestValidate_StorageMissingType(t *testing.T) {
	cfg := &Template{
		...
		Cluster:  ClusterTemplate{ControlPlanes: 1, Workers: 0},
		Plugins: PluginsTemplate{
			Storage: &StorageTemplate{Enabled: true},
		},
	}
	err := cfg.Validate()
	if err == nil {
...
func TestValidate_StorageInvalidType(t *testing.T) {
	cfg := &Template{
		...
		Cluster:  ClusterTemplate{ControlPlanes: 1, Workers: 0},
		Plugins: PluginsTemplate{
			Storage: &StorageTemplate{Enabled: true, Type: "openebs"},
		},
	}
	err := cfg.Validate()
	if err == nil {
...
func TestValidate_StorageValidType(t *testing.T) {
	cfg := &Template{
		...
		Cluster:  ClusterTemplate{ControlPlanes: 1, Workers: 0},
		Plugins: PluginsTemplate{
			Storage: &StorageTemplate{Enabled: true, Type: "local-path"},
		},
	}
	if err := cfg.Validate(); err != nil {
...
func TestValidate_DisabledStorageSkipsValidation(t *testing.T) {
	cfg := &Template{
		...
		Cluster:  ClusterTemplate{ControlPlanes: 1, Workers: 0},
		Plugins: PluginsTemplate{
			Storage: &StorageTemplate{Enabled: false, Type: "invalid"},
		},
	}
	if err := cfg.Validate(); err != nil {
...
func TestValidate_IngressMissingType(t *testing.T) {
	cfg := &Template{
		...
		Cluster:  ClusterTemplate{ControlPlanes: 1, Workers: 0},
		Plugins: PluginsTemplate{
			Ingress: &IngressTemplate{Enabled: true},
		},
	}
	err := cfg.Validate()
	if err == nil {
...
func TestValidate_MonitoringMissingType(t *testing.T) {
	cfg := &Template{
		...
		Cluster:  ClusterTemplate{ControlPlanes: 1, Workers: 0},
		Plugins: PluginsTemplate{
			Monitoring: &MonitoringTemplate{Enabled: true},
		},
	}
	err := cfg.Validate()
	if err == nil {
...
func TestValidate_MonitoringInvalidType(t *testing.T) {
	cfg := &Template{
		...
		Cluster:  ClusterTemplate{ControlPlanes: 1, Workers: 0},
		Plugins: PluginsTemplate{
			Monitoring: &MonitoringTemplate{Enabled: true, Type: "datadog"},
		},
	}
	err := cfg.Validate()
	if err == nil {
...
func TestValidate_MonitoringValidType(t *testing.T) {
	cfg := &Template{
		...
		Cluster:  ClusterTemplate{ControlPlanes: 1, Workers: 0},
		Plugins: PluginsTemplate{
			Monitoring: &MonitoringTemplate{Enabled: true, Type: "prometheus"},
		},
	}
	if err := cfg.Validate(); err != nil {
